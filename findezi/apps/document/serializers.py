...
from .models.document import LostDocument,FoundDocument,DocumentType
...
class LostDocSerializer(DocumentSerializer,dfms):
    ...
    def validate(self, attrs):
        try:
            ...
            raise ValidationError(_('this document has already been issued, is it yours ?'))
    ...
    def validate(self, attrs):
        try:
            LostDocument.objects.get(
                ...
                doc_name = attrs['doc_name'],
                doc_last_name = attrs['doc_last_name'],
                doc_ref_number = attrs['doc_ref_number']
            )
            raise ValidationError(_('this document has already been issued, have you find it ?'))
